...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:py="http://purl.org/kid/ns#"
    ...
    <?python 
        from rPath.outboundmirror.repeatschedule import MirrorScheduleWidget
    ?>
    <!--
    ...
    <body id="middle">
        ...
        <h5>NOTE: Update Service appliance(s) are updated between the hour selected 
            ...
            is saved.</h5>
        <p style="margin-bottom: 0px;">Scheduled outbound mirroring is:</p>
        ...
        <div id="updateNow"> 
        <span style="float: left; font-style: italic; width: 60%">To mirror to your Update Service appliance(s) immediately, click "Mirror Now."</span>
        <button class="img" onclick="startMirrorNow();"><img src="${tg.url('/outboundmirror/static/images/mirror_now.png')}"/></button>
        </div>
