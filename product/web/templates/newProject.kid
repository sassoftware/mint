            ...
            <form method="post" action="createProject" >
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="mainformhorizontal">
                    ...
                    <tr py:if="cfg.EnableMailLists">
                        <th>Mailing Lists:</th>
                        <td>
                            <p>By default, your ${projectText().lower()} will be created with two mailing lists:</p>
                                <ul>
                                    <li>&lt;${projectText().lower()}-name&gt;</li>
                                    <li>&lt;${projectText().lower()}-name&gt;-commits</li>
                                </ul>

                            <p>You can also select the following lists to be created along with your ${projectText().lower()}:</p>
