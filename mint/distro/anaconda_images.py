...
class AnacondaImages:
    ...
    images = [
        ...
        ["anaconda-header.png",     (800,58),       False,  (10,3),     30,     "background-800x58.png"],
        ["first-lowres.png",        (640,480),      True,   0.80,       40,     "background-640x480.png"],
        ["first.png",               (800,600),      True,   0.80,       40,     "background-800x600.png"],
        ["progress-first-375.png",  (353,170),      False,  0.80,       20,     "background-353x170.png"],
        ["progress-first.png",      (500,325),      False,  0.80,       40,     "background-500x325.png"],
        ["splash.png",              (400,420),      True,   0.33,       40,     "background-400x420.png"],
