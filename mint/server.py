...
If you would not like to be %s %s of this project, you may resign from this project at %smembers""" % \
    ...
    def createPackageTmpDir(self):
        ...
        @rtype: String
        @return: A X{sessionHandle} to be used with subsequent calls to package
        creator methods
        '''
    ...
    def getPackageFactories(self, projectId, sessionHandle, versionId, upload_url):
        '''
        Given a file represented by L{sessionHandle}, query the PC Service for
        ...
        @return: A list of the candidate build factories and the data scanned
        ...
        the package creator service, or if the L{sessionHandle} does not
        ...
        except packagecreator.errors.UnsupportedFileFormat, e:
            raise PackageCreatorError("Error gathering Candidate Build Factories: %s", "The file uploaded is not a supported file type")
    ...
    @requiresAuth
    def pollUploadStatus(self, sessionHandle, fieldname):
        """
        ...
        @raise PermissionDenied: If the L{sessionHandle} doesn't exist, or is
        invalid.
        """
        from mint.web import whizzyupload
        import packagecreator
    ...
    @requiresAuth
    def cancelUploadProcess(self, sessionHandle, fieldnames):
        """
        ...
        @return: True if the sessionHandle is a valid session, False otherwise.
        @rtype: boolean
        """
        from mint.web import whizzyupload
        import packagecreator
