...
class MigrateTo_58(SchemaMigration):
    ...
    def migrate3(self):
        schema._addTableRows(self.db, "querysets_queryset", "name", [
        dict(name="All User Notices", resource_type='user_notice',
        ...
        allUserNoticeFiltId = schema._getRowPk(self.db, "querysets_filterentry", 'filter_entry_id',
                field="notice", operator='IS_NULL', value="False")

        allUserNoticeQSId = schema._getRowPk(self.db, "querysets_queryset", "query_set_id", 
            name="All User Notices")
    ...
    def migrate4(self):
        ...
        allGlobalNoticeFiltId = schema._getRowPk(self.db, "querysets_filterentry", 'filter_entry_id',
                field="notice", operator='IS_NULL', value="False")

        allGlobalNoticeQSId = schema._getRowPk(self.db, "querysets_queryset", "query_set_id", 
