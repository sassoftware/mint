...
# 
    ...
    URL(r'images/(?P<image_id>\d+)/?$',
        ...
        name='Image'),
    URL(r'image_builds/?$',
        imagesviews.ImageBuildService(),
        name='ImageBuilds'),
    URL(r'image_builds/(?P<build_id>\d+)/?$',
        imagesviews.ImageBuildService(),
        name='ImageBuild'),
    URL(r'image_builds/(?P<build_id>\d+)/build_files/?$',
        imagesviews.ImageBuildFileService(),
        name='BuildFiles'),
    URL(r'image_builds/(?P<build_id>\d+)/build_files/(?P<file_id>\d+)/?$',
        imagesviews.ImageBuildFileService(),
        name='BuildFile'),
)
