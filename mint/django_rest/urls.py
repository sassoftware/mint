...
urlpatterns = patterns('',
    ...
    url(r'^api/inventory/systems/(?P<system_id>\d+)/?$',
        ...
        name='System'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/systemLog/$', 
    ...
    url(r'^api/inventory/systems/(?P<system_id>\d+)/jobs/$',
        ...
        name='SystemJobs'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/jobs/(?P<job_id>[a-zA-Z1-9]+)/$',
        inventoryviews.InventorySystemJobsService(),
        name='SystemJob'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/jobStates/(?P<job_state_id>[a-zA-Z1-9]+)/jobs/$',
        inventoryviews.InventorySystemJobStatesService(),
        name='SystemJobStateJobs'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/systemEvents/$', 
        inventoryviews.InventorySystemsSystemEventService(), 
        name='SystemsSystemEvent'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/systemLog/(?P<format>[a-zA-Z]+)/$', 
        inventoryviews.InventorySystemsSystemLogService(),
        name='SystemLogFormat'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/installedSoftware/$', 
    ...
    url(r'^api/inventory/systemEvents/$', 
        ...
        name='SystemEvents'),
    url(r'^api/inventory/systemEvents/(?P<system_event_id>\d+)/$', 
        inventoryviews.InventorySystemEventsService(), 
        name='SystemEvent'),
    ...
    url(r'^api/inventory/eventTypes/$', 
        ...
        name='EventTypes'),
    url(r'^api/inventory/eventTypes/(?P<event_type_id>\d+)/$', 
        inventoryviews.InventoryEventTypesService(), 
        name='EventType'),
    ...
    url(r'^api/inventory/jobs/$',
        ...
        name='Jobs'),
    url(r'^api/inventory/jobs/(?P<job_id>[a-zA-Z1-9]+)/$',
        inventoryviews.InventoryJobsService(),
        name='Job'),
    ...
    url(r'^api/inventory/jobStates/$',
        ...
        name='JobStates'),
    url(r'^api/inventory/jobStates/(?P<job_state_id>[a-zA-Z1-9]+)/$',
        inventoryviews.InventoryJobStatesService(),
        name='JobState'),
    url(r'^api/inventory/jobStates/(?P<job_state_id>[a-zA-Z1-9]+)/jobs/$',
