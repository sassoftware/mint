...
urlpatterns = patterns('',
    ...
    url(r'^api/inventory/systems/(?P<system_id>\d+)/jobs/(?P<job_id>[a-zA-Z0-9]+)/$',
        inventoryviews.InventorySystemJobsService(),
        name='SystemJob'),
    url(r'^api/inventory/systems/(?P<system_id>\d+)/jobStates/(?P<job_state_id>[a-zA-Z0-9]+)/jobs/$',
    ...
    url(r'^api/inventory/jobStates/$',
        ...
        name='JobStates'),
    url(r'^api/inventory/jobStates/(?P<job_state_id>[a-zA-Z0-9]+)/$',
        inventoryviews.InventoryJobStatesService(),
        name='JobState'),
    url(r'^api/inventory/jobStates/(?P<job_state_id>[a-zA-Z0-9]+)/jobs/$',
