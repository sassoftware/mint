...
urlpatterns = patterns('',
    ...
    URL(r'/survey_windows_os_patches/(?P<id>\d+)/?$',
        inventoryviews.SurveyWindowsOsPatchService(),
        name='SurveyWindowsOsPatch',
        model='inventory.WindowsOsPatch'),
    ...
    URL(r'/windows_os_patch_info/(?P<id>\d+)/?',
        inventoryviews.SurveyWindowsOsPatchInfoService(),
        name='SurveyWindowsOsPatchInfo',
        model='inventory.SurveyWindowsOsPatchInfo'),
