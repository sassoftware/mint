...
jobs_xml = """\
<?xml version="1.0"?>
<jobs count="3" end_index="2" filter_by="" full_collection="http://testserver/api/jobs/" id="http://testserver/api/jobs/" limit="10" next_page="" num_pages="1" order_by="" per_page="10" previous_page="" start_index="0">
...
systems_jobs_xml = """\
<?xml version="1.0"?>
<jobs count="3" end_index="2" filter_by="" full_collection="http://testserver/api/inventory/systems/3/jobs/" id="http://testserver/api/inventory/systems/3/jobs/" limit="10" next_page="" num_pages="1" order_by="" per_page="10" previous_page="" start_index="0">
  <job id="http://testserver/api/jobs/1">
    <job_description>System registration</job_description>
