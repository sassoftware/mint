...
-->
    ...
    <body>
        ...
        <p>
            ...
            BE BOUND BY THE TERMS AND CONDITIONS, DO NOT CLICK "ACCEPT", REMOVE ALL RPATH-PROVIDED SOFTWARE FROM THIS COMPUTER, AND 
        ...
        <form action="processTos" method="post">
            <input type="hidden" name="acceptTos" value="True" /><br />
