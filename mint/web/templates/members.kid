                ...
                <div id="middle">
                    ...
                    <div id="yourStatus" py:if="auth.authorized">
                        ...
                        <p py:if="userLevel == userlevels.OWNER">
                            You are currently ${onlyOwner and "the owner" or "an owner"} of this ${projectText().lower()}. You can manage membership here, adding other users as co-owners or developers to be part of the development team.  Use the search at the left to find an existing rBuilder user to add as co-owner or develop.
                        </p>
