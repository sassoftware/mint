        ...
        <div class="fullpage">
            ...
            <div id="leftcenter">
                ...
                <p py:if="limiters" py:string="True">
                    <div py:for="limiter in limiters" py:strip="True"><a href="search?type=$searchType;search=${limiter['newSearch']};modified=$modified;removed=1" class="imageButton"><img src="${cfg.staticPath}/apps/mint/images/x_out.gif" alt="remove" title="Remove" width="12" height="12" /></a>&nbsp;Showing <b>${limiter['desc']}</b></div></p>
