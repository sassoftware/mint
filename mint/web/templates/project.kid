...
<html xmlns:html="http://www.w3.org/1999/xhtml"
    ...
    <div py:def="projectResourcesMenu" id="project" class="palette">
        ...
        <ul>
            ...
            <li><a href="${projectUrl}groups"><strong py:strip="lastchunk not in ('groups', 'editGroup', 'editGroup2', 'newGroup', 'pickArch', 'cookGroup')">Group Builder</strong></a></li>
    ...
    <td py:def="projectsPane()" id="right" class="projects" py:strip="True">
        ...
        <div class="pad" py:if="output != 'xhtml'">
            <p class="help">
                ...
                Internet Explorer is not supported by ${cfg.productName}.
