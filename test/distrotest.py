...
class DistroTest(MintRepositoryHelper):
    ...
    def testExtractPublicKeys(self):
        ii = self.getInstallableIso()
        dat = ii._decodeKey('-----BEGIN PGP PUBLIC KEY BLOCK-----\nVersion: Conary 1.1.17\n\\n-----END PGP PUBLIC KEY BLOCK-----\n')
        self.failIf(md5.md5(dat).hexdigest() != 'ab549fbc9c08ecd657ffc5dc47f72f2a')
