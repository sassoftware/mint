...
class WebMemberTest(mint_rephelp.WebRepositoryHelper):
    ...
    def testRejectJoinReq(self):
        ...
        # reject it
        page = page.postForm(2, self.post, {"action" : "Reject Request"})
    ...
    def testOwnerJoinReq(self):
        ...
        # accept as owner
        page = page.postForm(2, self.post, {"action" : "Make Owner"})
    ...
    def testDevelJoinReq(self):
        ...
        # accept as developer
        page = page.postForm(2, self.post, {"action" : "Make Developer"})
